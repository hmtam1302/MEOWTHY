...
import {
    ...
    Image, TextInput, TouchableOpacity, ScrollView, Dimensions, ActivityIndicator
} from "react-native";
        ...
        <ImageBackground source={image} style={styles.imageBgContainer}>
            ...
            <View style={styles.footer}>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => login()}
                >
                    {loading ? <ActivityIndicator color="red" size="small" /> : <Text style={styles.textButton}>Đăng nhập</Text>}
                </TouchableOpacity>
